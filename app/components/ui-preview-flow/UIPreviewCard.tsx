...
import type { UIPreview } from '~/lib/stores/uiPreviewFlow';
...
export const UIPreviewCard: React.FC<UIPreviewCardProps> = ({ preview, onSelect }) => {
  const handleSelect = () => {
    onSelect(preview.id);
  };
    ...
    <motion.div
      ...
      className={classNames(
        ...
        preview.selected
          ...
          : 'border-bolt-elements-borderColor hover:border-blue-500/50'
      )}
    >
      ...
      <div className="p-3 bg-bolt-elements-background-depth-1">
        <div className="flex gap-2 mb-2">
          <button
            ...
            className={classNames(
              ...
              preview.selected
                ...
                : 'bg-bolt-elements-background-depth-2 text-bolt-elements-textPrimary hover:bg-blue-500/10 hover:text-blue-500'
            )}
          >
          ...
          <button
            ...
            className="p-2 rounded-md bg-bolt-elements-background-depth-2 text-bolt-elements-textPrimary hover:bg-blue-500/10 hover:text-blue-500 transition-colors"
